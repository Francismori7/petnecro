...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "C:\\Users\\Francis\\Documents\\PHPStorm\\Animociel\\resources\\assets\\js\\components\\DashboardEdit.vue"
  if (!module.hot.data) {
...
},{"vue":41,"vue-hot-reload-api":16}],43:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        canAddPets: function canAddPets() {
            return this.user.pets.length < this.user.maximum_pets;
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Francis\\Documents\\PHPStorm\\Animociel\\resources\\assets\\js\\components\\DashboardIndex.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":41,"vue-hot-reload-api":16}],44:[function(require,module,exports){
"use strict";
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Francis\\Documents\\PHPStorm\\Animociel\\resources\\assets\\js\\components\\Home.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\Users\\Francis\\Documents\\PHPStorm\\Animociel\\resources\\assets\\js\\components\\LoadingIndicator.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":41,"vue-hot-reload-api":16}],46:[function(require,module,exports){
"use strict";
...
var _DashboardIndex = require("./components/DashboardIndex.vue");

var _DashboardIndex2 = _interopRequireDefault(_DashboardIndex);

var _DashboardEdit = require("./components/DashboardEdit.vue");

var _DashboardEdit2 = _interopRequireDefault(_DashboardEdit);

var _LoadingIndicator = require("./components/LoadingIndicator.vue");
...
_vue2.default.http.headers.common['X-CSRF-TOKEN'] = document.querySelector('meta[name=token]').getAttribute('content');
...
_vue2.default.component('loading-indicator', _LoadingIndicator2.default);

new _vue2.default({
    el: '#app',
    components: {
        Home: _Home2.default,
        DashboardIndex: _DashboardIndex2.default,
        DashboardEdit: _DashboardEdit2.default
    },
    data: {
        user: null
    },
...
},{"./components/DashboardEdit.vue":42,"./components/DashboardIndex.vue":43,"./components/Home.vue":44,"./components/LoadingIndicator.vue":45,"bootstrap/dist/js/npm":1,"jquery":14,"jquery.payment":13,"vue":41,"vue-resource":30}]},{},[46]);
